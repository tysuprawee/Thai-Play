        ...
        <div className="container flex items-center justify-center min-h-[calc(100vh-4rem)] py-10">
            <Card className="w-full max-w-md bg-[#1e202e] border-white/5">
                <CardHeader className="text-center">
                    <CardTitle className="text-2xl font-bold text-white">สมัครสมาชิกใหม่</CardTitle>
                    <p className="text-sm text-gray-400">เข้าร่วมชุมชน ThaiPlay วันนี้</p>
                </CardHeader>
                <CardContent>
                    ...
                    <div className="relative mb-6">
                        ...
                        <div className="relative flex justify-center text-xs uppercase">
                            <span className="bg-[#1e202e] px-2 text-gray-400">หรือสมัครด้วยอีเมล</span>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleRegister} className="space-y-4">
                        <div className="space-y-2">
                            <Label htmlFor="fullname" className="text-gray-300">ชื่อที่ใช้แสดง (Display Name)</Label>
                            <Input
                                id="fullname"
